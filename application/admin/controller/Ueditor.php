...
//        	}
	...
	*/
	...
	public function imgUp()
	{
		...
		$result = $this->validate(
				['file2' => $file],
				['file2'=>'fileSize:30000000|fileExt:jpg,jpeg,gif,png'],
		...
		if (true !== $result || empty($file)) {
			...
			$info = $file->rule(function ($file) {
				$p = input('savepath');
				if($p == 'empty'){
					return 'icon_goods_thumb_empty_300.png';
				}
			...
			if($p == 'empty'){
				...
				$str = file_get_contents('./public/images/icon_goods_thumb_empty_300.png');
				file_put_contents('./template/mobile/default/static/images/zy.png',$str);
			}else{
				$return_data['url'] = $path.$info->getSaveName();
			}
		}
