...
class Kdniao{
    ...
    public function __construct($request_type = 1002){
        ...
        $apiUrl = array(
            1001=>'http://api.kdniao.com/api/OOrderService',//在线下单预约取件接口正式地址
            1002=>'http://api.kdniao.com/Ebusiness/EbusinessOrderHandle.aspx',//即时查询接口地址
            1007=>'http://api.kdniao.com/api/EOrderService',//电子面单正式接口地址    测试地址http://sandboxapi.kdniao.com:8080/kdniaosandbox/gateway/exterfaceInvoke.json
            1008=>'http://api.kdniao.com/api/dist',//物流跟踪正式接口地址
            2002=>'http://api.kdniao.com/Ebusiness/EbusinessOrderHandle.aspx',//单号识别接口地址，只需要录入单号即可完成查询
            1147=>'http://api.kdniao.com/api/EOrderService'
        );
