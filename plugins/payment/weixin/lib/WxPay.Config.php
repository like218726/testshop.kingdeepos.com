...
class WxPayConfig
{
    ...
    public function getSslPaths(){
	     ...
	     return [
			 'weixinH5'=>['ssl_cert'=>$realPath.DIRECTORY_SEPARATOR.'cert'.DIRECTORY_SEPARATOR.'weixinH5'.DIRECTORY_SEPARATOR.'apiclient_cert.pem' , 'ssl_key'=>$realPath.DIRECTORY_SEPARATOR.'cert'.DIRECTORY_SEPARATOR.'weixinH5'.DIRECTORY_SEPARATOR.'apiclient_key.pem'],
    	     ...
    	     'root_ca'=>$realPath.DIRECTORY_SEPARATOR.'cert'.DIRECTORY_SEPARATOR.'rootca.pem'
    	 ];
	 }
