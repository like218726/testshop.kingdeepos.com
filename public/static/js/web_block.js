...
function add_slide_adv() {//增加图片
	for (var i = 1; i <= slide_pic_max; i++) {//防止数组下标重复
		if ($("#upload_advbig_form ul li[slide_adv_id='"+i+"']").size()==0) {//编号不存在时添加
			...
			var add_html = '';
			add_html = '<li class="ui-sortable-handle " slide_adv_id="'+i+'"><div class="adv-pic"><span class="ac-ico" onclick="del_slide_adv('+i+');"></span><img onclick="select_slide_adv('+i+');" src="/public/static/images/picture.gif"  width="106px" height="112px"/></div>'+text_input+'</li>';
