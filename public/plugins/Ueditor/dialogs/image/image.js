...
(function () {
            ...
            uploader.on('all', function (type, files) {
                switch (type) {
                    ...
                    case 'startUpload':
                        ...
                        var album_id =  $G('image_album').value;
            ...
            uploader.on('uploadSuccess', function (file, ret) {
                ...
                try {
                    ...
                    if (json.state == 'SUCCESS') {
						...
						_this.imageList[$file.index()]=json; // 上传图片顺序
    ...
    OnlineImage.prototype = {
        ...
        initEvents: function () {
            ...
            /*相册下拉框改变*/
            domUtils.on($G('image_album'), 'change', function(e){
            	var target = e.target || e.srcElement;
            	var album_id = target.value;	
            	if(tab_id != 'online')return;
            	/**重置各个状态*/
        ...
        getImageData: function () {
            ...
            if(!_this.listEnd && !this.isLoadingData) {
                ...
                if(document.getElementById("image_album")){
                	var album_id = document.getElementById("image_album").value;
                	url += "&album_id="+album_id;
                }
        ...
        pushData: function (list) {
            ...
            for (i = 0; i < list.length; i++) {
                if(list[i] && list[i].url) {
                    ...
                    item.setAttribute('title', list[i].name);
