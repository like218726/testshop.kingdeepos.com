   ...
   <div id="sidebar" class="sidebar">
    ...
    <div id="layoutRight" class="ncsc-layout-right">
        ...
        <div class="main-content" id="mainContent">
            <div class="tabmenu">
                <ul class="tab pngFix">
                    <li class="active"><a href="<?php echo U('Freight/index'); ?>">模板列表</a></li>
                </ul>
                <a href="<?php echo U('Freight/info'); ?>" class="ncbtn ncbtn-mint" title="新增运费模板"><i class="icon-plus-sign"></i>新增运费模板</a>
            ...
            <?php if(is_array($template_list) || $template_list instanceof \think\Collection || $template_list instanceof \think\Paginator): $i = 0; $__LIST__ = $template_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$template): $mod = ($i % 2 );++$i;?>
                <div class="tp-around-wraps">
                    <div class="tp-left-tips"><?php echo $template['template_name']; ?></div>
                    <div class="tp-left-tips"><?php echo $template['type_desc']; ?></div>
					<?php if($template['ownership'] == 0): ?>
						<div class="fr">
							<a href="<?php echo U('Freight/info',['template_id'=>$template['template_id']]); ?>" target="_blank" class="ncbtn ncbtn-mint" title="编辑"><i class="icon-plus-sign"></i>编辑</a>
							<a class="ncbtn ncbtn-mint delete_template" data-template-id="<?php echo $template['template_id']; ?>" title="删除"><i class="icon-plus-sign"></i>删除</a>
						</div>
					<?php else: ?>
						<div class="fr">供应商运费模板，不接受编辑</div>
					<?php endif; ?>
                </div>
                <table class="ncsc-default-table">
                    ...
                    <tr>
                        ...
                        <th class="w100">首<?php echo $template['type_desc']; ?>(<?php echo $template['unit_desc']; ?>)</th>
                        <th class="w100">运费(元)</th>
                        <th class="w100">续<?php echo $template['type_desc']; ?>(<?php echo $template['unit_desc']; ?>)</th>
                    ...
                    <?php if(count($template[freightConfig]) > 5): ?>
                        <tfoot>
                        <tr>
                            <td colspan="20">
                                <a href="<?php echo U('Freight/info',['template_id'=>$template['template_id']]); ?>">查看更多</a>
                            </td>
                        </tr>
                        </tfoot>
                    <?php endif; ?>
