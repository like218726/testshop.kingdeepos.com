<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:55:"./application/admin/view/promotion/prom_order_list.html";i:1587634374;s:79:"/home/wwwroot/testshop.kingdeepos.com/application/admin/view/public/layout.html";i:1587634374;}*/ ?>
<!doctype html>
<html>
<head>
			...
			<form class="navbar-form form-inline" id="search-form" action="<?php echo U('Promotion/prom_order_list'); ?>" method="get" onsubmit="return check_form();">
				<div class="sDiv">
					<div class="sDiv2" style="margin-right: 10px;">
						<input type="text" size="30" id="start_time" value="<?php echo $start_time; ?>" name="start_time" placeholder="起始时间" class="qsbox">
						<input type="button" class="btn" value="起始时间">
					</div>
					<div class="sDiv2" style="margin-right: 10px;">
						<input type="text" size="30" id="end_time" value="<?php echo $end_time; ?>" name="end_time" placeholder="截止时间" class="qsbox">
					...
					<div class="sDiv2">
						<select name="status" class="select">
                            ...
                            <option value="2" <?php if($status == 2): ?>selected<?php endif; ?>>已过期</option>
						</select>
