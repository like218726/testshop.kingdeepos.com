<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:44:"./application/admin/view/shipping/index.html";i:1587634374;s:79:"/home/wwwroot/testshop.kingdeepos.com/application/admin/view/public/layout.html";i:1587634374;}*/ ?>
<!doctype html>
<html>
<head>
	...
	<div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                <li><a class="current" href="<?php echo U('Shipping/index'); ?>" data-state="" ><span>快递公司管理</span></a></li>
                <!-- <li><a href="<?php echo U('user/commentList'); ?>" data-state="0"  ><span>评论审核</span></a></li> -->
                <li><a href="<?php echo U('Shipping/express'); ?>" data-state="0"  ><span>物流信息配置</span></a></li>
            </ul>
        </div> 
    </div>
	<!-- 操作说明 -->
				...
				<table cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<th align="left" axis="col4" class="">
							<div style="text-align: left; width: 150px;" class="">物流公司编码</div>
						</th>
						<th align="center" axis="col5" class="">
							<div style="text-align: center; width: 200px;" class="">物流描述</div>
						</th>
				...
				<table>
					...
					<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$shipping): $mod = ($i % 2 );++$i;?>
						<tr>
							...
							<td align="left" class="">
								<div style="text-align: center; width: 150px;"><?php echo $shipping['shipping_code']; ?></div>
							</td>
							<td align="left" class="">
								<div style="text-align: center; width: 200px;"><?php echo $shipping['shipping_desc']; ?></div>
							</td>
...
<script>
	...
	$(function(){
		$(document).on('click','.deleteShipping',function(){
			...
			var alertMsg = '确认删除吗？店铺使用该快递公司的记录也将一并删除!';
