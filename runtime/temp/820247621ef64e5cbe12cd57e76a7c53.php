<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:49:"./application/admin/view/mobile_app/mini_app.html";i:1587634374;s:79:"/home/wwwroot/testshop.kingdeepos.com/application/admin/view/public/layout.html";i:1587634374;}*/ ?>
<!doctype html>
<html>
<head>
        ...
        <div class="ncap-form-default">
            <dl class="row">
                ...
                <dd class="opt">
                    ...
                    <p class="notic">用于小程序在审核期间隐藏一些功能以便顺利通关审核.</p>
                </dd>
            </dl> 
            <!--<dl class="row">-->
                <!--<dt class="tit">-->
                    <!--<label for="app_path">IOS下载地址</label>-->
                <!--</dt>-->
                <!--<dd class="opt">-->
                    <!--<input id="app_path" name="app_path" value="<?php echo $config['app_path']; ?>" class="input-txt" style="width:500px" type="text" />-->
                    <!--<p class="notic">请填写IOS下载地址</p>-->
                <!--</dd>-->
            <!--</dl>-->
            <div class="bot">
