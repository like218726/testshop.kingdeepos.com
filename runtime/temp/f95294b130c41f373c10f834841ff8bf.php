...
<form method="post" action="">
  <table class="search-form">
    ...
    <tr>
      ...
      <th>投诉时间</th>
      <td class="w400">
      	<input name="start_time" id="add_time_from" type="text" class="text w120" value="<?php echo \think\Request::instance()->param('start_time'); ?>" /><label class="add-on"><i class="icon-calendar"></i></label> &#8211;
      	<input name="end_time" id="add_time_to" type="text" class="text w120" value="<?php echo \think\Request::instance()->param('end_time'); ?>" /><label class="add-on"><i class="icon-calendar"></i></label></td>
