   ...
   <div id="sidebar" class="sidebar">
    ...
    <div id="layoutRight" class="ncsc-layout-right">
        ...
        <div class="main-content" id="mainContent">
            <div class="tabmenu">
                <ul class="tab pngFix">
                    <li class="active"><a href="<?php echo U('Seller/Service/ask_list'); ?>">商品咨询列表</a></li>
                </ul>
            </div>
...
<script>
    ...
    function ajax_get_table(tab,page){
        ...
        $.ajax({
            type : "POST",
            url:"/index.php/Seller/Service/ajax_ask_list/p/"+page,//+tab,
