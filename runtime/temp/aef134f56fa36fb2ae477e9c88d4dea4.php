<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:50:"./application/admin/view/promotion/flash_sale.html";i:1587634374;s:79:"/home/wwwroot/testshop.kingdeepos.com/application/admin/view/public/layout.html";i:1587634374;}*/ ?>
<!doctype html>
<html>
<head>
				...
				<table cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<th align="left" abbr="ac_id" axis="col4" class="">
							<div style="text-align: center; width: 80px;" class="">抢购总量</div>
						</th>
				...
				<table>
					...
					<?php if(is_array($prom_list) || $prom_list instanceof \think\Collection || $prom_list instanceof \think\Paginator): if( count($prom_list)==0 ) : echo "" ;else: foreach($prom_list as $k=>$vo): ?>
						<tr>
							...
							<td align="left" class="">
								<div style="text-align: center; width: 240px;"><?php echo $vo['goods_name']; ?></div>
							</td>
							<td align="left" class="">
							...
							<td align="left" class="handle">
								<div style="text-align: center; width: 170px; max-width:170px;">
									...
									<?php endif; if($vo['status'] == 1 && $vo[end_time] > time()): ?>
										<a class="btn red closeProm" data-item-id="<?php echo $vo['item_id']; ?>" data-goods-id="<?php echo $vo['goods_id']; ?>" data-prom-id="<?php echo $vo['id']; ?>"><i class="fa fa-close"></i>取消</a>
									<?php endif; ?>
