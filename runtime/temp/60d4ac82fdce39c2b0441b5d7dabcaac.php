<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:50:"./application/seller/new/public/dispatch_jump.html";i:1587634378;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
...
.recigle .copyright{color: #3c8dbc;}
	...
	<body class="tranjump">
		<div class="rectangle_box">
			<div class="borderopely">
				...
				<div class="tipbox" style="">
					...
					<div class="ma-to-10">
						...
						<a href="/index.php?m=Seller&c=Index&a=index" target="_parent" class="waittim ht-colblue">管理员后台</a>
					</div>
				</div>
				<!--修改成功-e-->
				<?php }else{?>
			...
			<div class="recigle">
				<p>Copyright©2014-2017<em class="copyright"><a class="copyright" href="http://www.tpshop.cn/">TPSHOP v3.0.0</a></em></p>
