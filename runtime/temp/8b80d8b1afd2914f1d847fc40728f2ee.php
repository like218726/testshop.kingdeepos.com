<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"./application/admin/view/store/store_list.html";i:1587634374;s:79:"/home/wwwroot/testshop.kingdeepos.com/application/admin/view/public/layout.html";i:1587634374;}*/ ?>
<!doctype html>
<html>
<head>
			...
			<div class="hDivBox">
				<table cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<th align="left" abbr="article_show" axis="col5" class="">
							<div style="text-align: center; width: 80px;" class="">推荐人</div>
						</th>
						<th align="left" abbr="article_show" axis="col5" class="">
							<div style="text-align: center; width: 50px;" class="">店铺会员</div>
						</th>
						...
						<th align="center" abbr="article_time" axis="col6" class="">
							<div style="text-align: center; width: 80px;" class="">进驻日期</div>
						</th>
                        <th align="center" abbr="article_time" axis="col6" class="">
                            <div style="text-align: center; width: 80px;" class="">有效期</div>
                        </th>
						<th align="center" abbr="article_time" axis="col6" class="">
							<div style="text-align: center; width: 80px;" class="">营业额</div>
						</th>
						<th align="center" abbr="article_time" axis="col6" class="">
							<div style="text-align: center; width: 40px;" class="">状态</div>
						</th>
						<th align="center" abbr="article_time" axis="col6" class="">
							<div style="text-align: center; width: 40px;" class="">推荐</div>
						</th>
				...
				<table>
					...
					<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $k=>$vo): ?>
						<tr>
							...
							<td align="left" class="">
								<div style="text-align: left; width: 100px;"><?php echo $vo['store_name']; ?></div>
							</td>
							<td align="left" class="">
							...
							<td align="left" class="">
								<div style="text-align: center; width: 80px;"><?php echo !empty($vo['InviteUser']['user_id'])?$vo['InviteUser']['nickname']?$vo['InviteUser']['nickname']:$vo['InviteUser']['mobile']:'无'; ?></div>
							</td>
							<td align="left" class="">
								<div style="text-align: left; width: 50px;"><?php echo $vo['store_member_count']; ?></div>
							</td>
							...
							<td align="center" class="">
								<div style="text-align: center; width: 80px;"><?php echo date('Y-m-d',$vo['store_time']); ?></div>
							</td>
                            <td align="center" class="">
							...
							<td align="center" class="">
								<div style="text-align: center; width: 80px;"><?php echo $vo['StoreOrderSum']; ?></div>
							</td>
							<td align="center" class="">
								<div style="text-align: center; width: 40px;">
