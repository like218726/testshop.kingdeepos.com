   ...
   <div id="sidebar" class="sidebar">
	...
	<div id="layoutRight" class="ncsc-layout-right">
		<div class="ncsc-path"><i class="icon-desktop"></i>商家管理中心<i class="icon-angle-right"></i>促销<i class="icon-angle-right"></i>订单促销管理
            <a href="http://help.tp-shop.cn/Index/Help/info/cat_id/24/id/217.html" class="seller_help" target="_blank">帮助</a>
		</div>
		<div class="main-content" id="mainContent">
			<div class="tabmenu">
				<ul class="tab pngFix">
					<li class="active"><a href="<?php echo U('Promotion/prom_order_list'); ?>">订单促销列表</a></li>
				</ul>
				<!--<a href="" style="right:100px" class="ncbtn ncbtn-mint" title="新增虚拟商品抢购"><i class="icon-plus-sign"></i>新增虚拟抢购</a>-->
				<a href="<?php echo U('Promotion/prom_order_info'); ?>" class="ncbtn ncbtn-mint" title="新增活动"><i class="icon-plus-sign"></i>新增活动</a>
			</div>
			...
			<table class="ncsc-default-table">
				...
				<?php if(is_array($prom_list) || $prom_list instanceof \think\Collection || $prom_list instanceof \think\Paginator): if( count($prom_list)==0 ) : echo "" ;else: foreach($prom_list as $k=>$vo): ?>
					<tr class="bd-line">
						...
						<td><?php echo $vo['prom_desc']; ?></td>
						<td><?php echo date('Y-m-d',$vo['start_time']); ?></td>
						<td><?php echo date('Y-m-d',$vo['end_time']); ?></td>
						<td><?php echo $vo['status_desc']; ?></td>
						<td class="nscs-table-handle">
                                <span><a href="<?php echo U('Promotion/prom_order_info',array('id'=>$vo['id'])); ?>" class="btn-bluejeans"><i class="icon-edit"></i><p>编辑</p></a></span>
                                <span><a href="javascript:;" class="btn-grapefruit" onclick="delfun(this,<?php echo $vo['id']; ?>)"><i class="icon-trash"></i><p>删除</p></a></span>
						</td>
					</tr>
				<?php endforeach; endif; else: echo "" ;endif; ?>
				</tbody>
