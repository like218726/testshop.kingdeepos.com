   ...
   <div id="sidebar" class="sidebar">
    ...
    <div id="layoutRight" class="ncsc-layout-right">
        ...
        <div class="main-content" id="mainContent">
            <div class="tabmenu">
                <ul class="tab pngFix">
                    <li class="normal"><a href="<?php echo U('Promotion/prom_goods_list'); ?>">订单促销列表</a></li>
            ...
            <div class="ncsc-form-default">
                <form method="post" id="promotion">
                    ...
                    <dl>
                        ...
                        <dd>
                            <select id="prom_type" name="type" class="select">
                                <option value="0" <?php if($info[type] == 0): ?>selected<?php endif; ?>>满额打折</option>
                                <option value="1" <?php if($info[type] == 1): ?>selected<?php endif; ?>>满额优惠金额</option>
                                <!--<option value="2" <?php if($info[type] == 2): ?>selected<?php endif; ?>>满额送积分</option>-->
                                <option value="3" <?php if($info[type] == 3): ?>selected<?php endif; ?>>满额送优惠券</option>
                            </select>
                    ...
                    <dl>
                        ...
                        <dd>
                            <input name="money" id="money" value="<?php echo $info['money']; ?>"  onpaste="this.value=this.value.replace(/[^\d.]/g,'')" onkeyup="this.value=this.value.replace(/[^\d.]/g,'')" type="text" class="text w130"/>
                            <span></span>
                            <p class="hint">单位：元</p>
                        </dd>
                    </dl>
                    ...
                    <dl>
                        ...
                        <dd>
                            <input id="end_time" name="end_time" value="<?php echo $info['end_time']; ?>" type="text" class="text w130"/><em class="add-on">
            ...
            <script type="text/javascript">
                ...
                function adsubmit(){
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo U('Promotion/prom_order_save'); ?>",
                        ...
                        success: function (data) {
                            if (data.status == 1) {
                                ...
                                window.location.href = "<?php echo U('Seller/Promotion/prom_order_list'); ?>";
                            } else {
