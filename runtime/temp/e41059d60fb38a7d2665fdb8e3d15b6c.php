<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:42:"./application/admin/view/plugin/index.html";i:1587634374;s:79:"/home/wwwroot/testshop.kingdeepos.com/application/admin/view/public/layout.html";i:1587634374;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    ...
    <!-- 操作说明 -->
    <div id="explanation" class="explanation" style="color: rgb(44, 188, 163); background-color: rgb(243, 244, 244); width: 99%; height: auto;">
        <div id="checkZoom" class="title"><i class="fa fa-lightbulb-o"></i>
            <h4 title="提示相关设置操作时应注意的要点">操作提示</h4>
			<ul>
                <li>插件内部包括: 支付插件、登录插件、物流插件、</li>
                <li style="color:red;">1.APP跟PC网站支付宝支是同一个配置, 只需在"PC端支付宝支付"配置项配置",密钥"即可实现APP支付"密钥"配置请参考"APP支付宝支付"手册文档</li>
                <li style="color:red;">2.小程序微信登录统一在"微信小程序支付"配置(小程序微信登录不单独配置), 只需配置好"微信小程序支付"即可</li>
            </ul>
                ...
                <table cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <th align="left" abbr="ac_id" axis="col4" class="">
                            <div style="text-align: left; width: 230px;" class="">插件描述</div>
                        </th>
                ...
                <table>
                    ...
                    <?php if(is_array($payment) || $payment instanceof \think\Collection || $payment instanceof \think\Paginator): $i = 0; $__LIST__ = $payment;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$p): $mod = ($i % 2 );++$i;?>
                        <tr>
                            ...
                            <td align="left" class="">
                                <div style="text-align: left; width: 230px;"><?php echo $p['desc']; ?></div>
                            </td>
                            <td align="left" class="">
