<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:40:"./application/admin/view/user/index.html";i:1587634374;s:79:"/home/wwwroot/testshop.kingdeepos.com/application/admin/view/public/layout.html";i:1587634374;}*/ ?>
<!doctype html>
<html>
<head>
                ...
                <table cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <th align="center" abbr="total_amount" axis="col6" class="">
                            <div style="text-align: center; width: 100px;" class="">累计消费</div>
                        </th>
                        ...
                        <th align="center" axis="col6" class="">
                            <div style="text-align: center; width: 50px;" class="">一级下线</div>
                        </th>
                        <th align="center" axis="col6" class="">
                            <div style="text-align: center; width: 50px;" class="">二级下线</div>
                        </th>
                        <th align="center" axis="col6" class="">
                            <div style="text-align: center; width: 50px;" class="">三级下线</div>
                        </th>
...
<script>
    ...
    {
        var obj = $('.trSelected');
        var url = "<?php echo U('User/export_user'); ?>";
        if(obj.length > 0){
            var check_val = [];
            obj.each(function(){
                check_val.push($(this).attr('data-id'));
