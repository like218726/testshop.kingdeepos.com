<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:41:"./application/admin/view/admin/index.html";i:1587634374;s:79:"/home/wwwroot/testshop.kingdeepos.com/application/admin/view/public/layout.html";i:1587634374;}*/ ?>
<!doctype html>
<html>
<head>
				...
				<table cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<th align="center" abbr="article_time" axis="col3" class="">
							<div style="text-align: left; width: 100px;" class="">绑定分站</div>
						</th>
				...
				<table>
					...
					<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $k=>$vo): ?>
						<tr>
							...
							<td align="left" class="">
								<div style="text-align: left; width: 100px;"><?php echo $vo['city_site']; ?></div>
							</td>
