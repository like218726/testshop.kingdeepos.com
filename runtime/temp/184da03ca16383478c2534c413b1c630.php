<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:56:"./application/admin/view/distribut/distributor_list.html";i:1587634374;s:79:"/home/wwwroot/testshop.kingdeepos.com/application/admin/view/public/layout.html";i:1587634374;}*/ ?>
<!doctype html>
<html>
<head>
          ...
          <thead>
	        	<tr>
	              ...
	              <th align="left" abbr="order_sn" axis="col3" class="">
	                <div style="text-align: left; width: 30px;" class="">编号</div>
	              </th>
	              <th align="left" abbr="consignee" axis="col4" class="">
	                <div style="text-align: left; width: 120px;" class="">微信昵称</div>
	              </th>
	              <th align="center" abbr="article_show" axis="col5" class="">
	                <div style="text-align: center; width: 100px;" class="">可用资金</div>
	              </th>
	              <th align="center" abbr="article_time" axis="col6" class="">
	                <div style="text-align: center; width: 100px;" class="">冻结资金</div>
	              </th>
	              <th align="center" abbr="article_time" axis="col6" class="">
	                <div style="text-align: center; width: 100px;" class="">总分成金额</div>
	              </th>
	              <th align="center" abbr="article_time" axis="col6" class="">
			...
			<?php else: if(is_array($user_list) || $user_list instanceof \think\Collection || $user_list instanceof \think\Paginator): $i = 0; $__LIST__ = $user_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
		        	<tr>
		              ...
		              <td align="left" abbr="order_sn" axis="col3" class="">
		                <div style="text-align: left; width: 30px;" class=""><?php echo $v['user_id']; ?></div>
		              </td>
		              <td align="left" abbr="consignee" axis="col4" class="">
		                <div style="text-align: left; width: 120px;" class=""><?php echo $v['nickname']; ?></div>
		              </td>
		              <td align="center" abbr="article_show" axis="col5" class="">
		                <div style="text-align: center; width: 100px;" class=""><?php echo $v['user_money']; ?></div>
		              </td>
		              <td align="center" abbr="article_time" axis="col6" class="">
		                <div style="text-align: center; width: 100px;" class=""><?php echo $v['frozen_money']; ?></div>
		              </td>
		              <td align="center" abbr="article_time" axis="col6" class="">
		                <div style="text-align: center; width: 100px;" class=""><?php echo $v['distribut_money']; ?></div>
		              </td>
		              <td align="center" abbr="article_time" axis="col6" class="">
		              ...
		              <td align="center" abbr="article_time" axis="col6" class="">
			                <div style="text-align: center; width: 80px;" class="">
				                <?php if($v[fisrt_leader] > 0): ?>
	                            	<a href="<?php echo U('Admin/User/index',array('first_leader'=>$v['user_id'])); ?>"><?php echo $v['fisrt_leader']; ?><i class="fa fa-eye"></i></a>
	                            <?php else: ?>
	                            	0
	                             <?php endif; ?>
			                </div>
		              ...
		              <td align="center" abbr="article_time" axis="col6" class="">
			                <div style="text-align: center; width: 80px;" class="">
				                <?php if($v[second_leader] > 0): ?>
	                            	<a href="<?php echo U('Admin/User/index',array('second_leader'=>$v['user_id'])); ?>"><?php echo $v['second_leader']; ?><i class="fa fa-eye"></i></a>
	                            <?php else: ?>
	                            	0
	                             <?php endif; ?>
			                </div>
		              ...
		              <td align="center" abbr="article_time" axis="col6" class="">
		                <div style="text-align: center; width: 80px;" class="">
				                <?php if($v[third_leader] > 0): ?>
	                            	<a href="<?php echo U('Admin/User/index',array('third_leader'=>$v['user_id'])); ?>"><?php echo $v['third_leader']; ?><i class="fa fa-eye"></i></a>
	                            <?php else: ?>
	                            	0
	                             <?php endif; ?>
			                </div>
		              ...
		              <td align="center" axis="col1" class="handle">
		                <div style="text-align: center; width: 150px;">
							...
							<a class="btn green" href="<?php echo U('Admin/Distribut/my_store',array('id'=>$v[user_id])); ?>"><i class="fa fa-shopping-cart"></i>微店</a>
						</div>
		              </td>
