<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"./application/admin/view/coupon/noob_info.html";i:1587634374;s:79:"/home/wwwroot/testshop.kingdeepos.com/application/admin/view/public/layout.html";i:1587634374;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <form class="form-horizontal" id="handleposition" method="post">
        ...
        <div class="ncap-form-default">
            ...
            <dl class="row" style="display: none">
                ...
                <dd class="opt">
                    <input type="text" id="createnum" name="createnum" value="<?php echo (isset($coupon['createnum']) && ($coupon['createnum'] !== '')?$coupon['createnum']:0); ?>" onpaste="this.value=this.value.replace(/[^\d]/g,'')" onkeyup="this.value=this.value.replace(/[^\d]/g,'')" class="input-txt">
            ...
            <dl class="row" style="display: none">
                ...
                <dd class="opt ctype">
                    <input name="type" type="radio" value="4" checked >新人优惠券</label>
                </dd>
            </dl>
            <dl class="row timed">
                <dt class="tit">
            ...
            <dl class="row">
                <dt class="tit">
                    <label><em>*</em>使用有效期</label>
                </dt>
                <dd class="opt">
                    <input type="text" id="validity_day" name="validity_day" value="<?php echo (isset($coupon['validity_day']) && ($coupon['validity_day'] !== '')?$coupon['validity_day']:3); ?>">天
                    <span class="err" id="err_validity_day"></span>
                    <p class="notic">使用有效期</p>
                </dd>
            </dl>
            <dl class="row">
                <dt class="tit">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <label><input name="status" type="radio" value="1" <?php if($coupon['status'] != 2): ?>checked<?php endif; ?> >有效</label>
                    <label><input name="status" type="radio" value="2" <?php if($coupon['status'] == 2): ?>checked<?php endif; ?> >无效</label>
                </dd>
            </dl>
                <div class="bot">
...
<script type="text/javascript">
            ...
            success: function (data) {
                ...
                if (data.status == 1) {
                    layer.msg(data.msg, {icon: 1},function () {
                        location.href = "<?php echo U('Admin/Coupon/noob'); ?>";
                    });
                } else {
    ...
    function selectGoods(){
        ...
        var url = '/index.php?m=admin&c=Promotion&a=search_good&exvirtual=1&nospec=1&goods_id='+goods_id+'&t='+Math.random();
        layer.open({
            type: 2,
            title: '选择商品',
            shadeClose: true,
