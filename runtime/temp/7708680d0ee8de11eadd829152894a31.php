<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:47:"./application/admin/view/news/categoryList.html";i:1587634374;s:79:"/home/wwwroot/testshop.kingdeepos.com/application/admin/view/public/layout.html";i:1587634374;}*/ ?>
<!doctype html>
<html>
<head>
  ...
  <form method="post">
    ...
    <div class="flexigrid">
      <div class="mDiv">
        ...
        <a href="<?php echo U('News/category'); ?>"><div class="fbutton"><div class="add" title="新增分类"><span><i class="fa fa-plus"></i>新增分类</span></div></div></a> 
        <div class="fbutton"><div class="add" title="收缩分类"><span onclick="tree_open(this);"><i class="fa fa-angle-double-up"></i>收缩分类</span></div></div>
      </div>
      <div class="hDiv">
        <div class="hDivBox">
      ...
      <!--<div class="tDiv">
        <div class="tDiv2">
         <a href="<?php echo U('News/category'); ?>">
          <div class="fbutton">
        ...
        <table class="flex-table autoht" cellpadding="0" cellspacing="0" border="0" id="article_cat_table">
          ...
          <?php if(is_array($cat_list) || $cat_list instanceof \think\Collection || $cat_list instanceof \think\Paginator): if( count($cat_list)==0 ) : echo "" ;else: foreach($cat_list as $k=>$vo): ?>
            <tr nctype="0" class="parent_id_<?php echo $vo[parent_id]; ?>" data-level="<?php echo $vo[level]; ?>"  id="<?php echo $vo['level']; ?>_<?php echo $vo['cat_id']; ?>">
              <td class="sign">
                <div style="text-align: center; width: 24px;"><i class="ico-check"></i></div>
                <div style="text-align: center; width: 24px;display: none">
              ...
              <td class="handle" style="display:none;">
                <div style="text-align:center;   min-width:150px !important; max-width:inherit !important;">
                  ...
                  <ul>
                     <li><a href="<?php echo U('News/category',array('act'=>'edit','cat_id'=>$vo['cat_id'])); ?>">编辑分类信息</a></li>                  
                                     
                     <li><a href="<?php echo U('News/category',array('parent_id'=>$vo['cat_id'])); ?>">新增下级分类</a></li>
	                   
                     <li><a href="javascript:void(0)" data-url="<?php echo U('News/categoryHandle'); ?>" data-id="<?php echo $vo['cat_id']; ?>" onClick="delfun(this)">删除当前分类</a></li>                                   
                  </ul>
                  </span>
                </div>
              </td>
