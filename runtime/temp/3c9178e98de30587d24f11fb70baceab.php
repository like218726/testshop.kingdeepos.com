...
<div class="ncsc-layout wrapper">
   ...
   <div id="sidebar" class="sidebar">
    ...
    <div id="layoutRight" class="ncsc-layout-right">
        ...
        <a href="http://help.tp-shop.cn/Index/Help/info/cat_id/24/id/214.html" class="seller_help" target="_blank">帮助</a>
        </div>
        <div class="main-content" id="mainContent">
            <div class="tabmenu">
                ...
                <a href="<?php echo U('Promotion/flash_sale_info',['prom_type'=>1]); ?>" class="ncbtn ncbtn-mint" title="新增抢购"><i class="icon-plus-sign"></i>新增抢购</a>

            </div>
            <div class="alert alert-block mt10">
                <ul class="mt5">
                    <li>点击新增抢购按钮可以添加抢购活动</li>
                    <li>只有在总平台设置了推荐，对应的活动才会显示在前台</li>
                    <li>活动时间必须是同一天的双数整点（如：8:00-10:00)，否则活动将不能正常显示</li>
                    <li>每个商品，只能参与一种活动，但积分商品不能参与活动。</li>
                </ul>
            </div>
            <form action="" id="search-form2" method="post" >
                <table class="search-form">
                    ...
                    <tr>
                        <td>&nbsp;</td>
                        <td class="w160"><input type="text" class="text w150" name="key_word" value="<?php echo $key_word; ?>" placeholder="活动名称/商品名" /></td>
			  ...
			  <?php else: ?> 
                ...
                <?php if(is_array($prom_list) || $prom_list instanceof \think\Collection || $prom_list instanceof \think\Paginator): if( count($prom_list)==0 ) : echo "" ;else: foreach($prom_list as $k=>$vo): ?>
                    <tr class="bd-line">
                        <td></td>
                        <td>
                            <div class="pic-thumb"><a target="_blank" href="<?php echo U('Home/Goods/goodsInfo',['id'=>$vo[goods_id],'item_id'=>$vo[item_id]]); ?>"><img src="<?php echo goods_thum_images($vo['goods_id'],200,200,$vo['item_id']); ?>"/></a></div>
                        </td>
                        <td class="tl"  style="white-space: nowrap;width: 100px;overflow: hidden;">
                            <dl class="goods-name">
                                <dt style="max-width: 160px !important;padding:0 16px">
                                    <a target="_blank" href="<?php echo U('Home/Goods/goodsInfo',['id'=>$vo[goods_id],'item_id'=>$vo[item_id]]); ?>"><?php echo $vo['title']; ?></a>
                                </dt>
                            </dl>
                        </td>
                        <td style="width: 200px;overflow: hidden;text-align: left;">
                            <a  target="_blank" href="<?php echo U('Home/Goods/goodsInfo',['id'=>$vo[goods_id],'item_id'=>$vo[item_id]]); ?>"><?php echo $vo['goods_name']; ?></a>
                        </td>
                        ...
                        <td class="nscs-table-handle">
                            <?php if($vo['edit_status'] == 1): ?>
                                <span>
                                    <a href="<?php echo U('Promotion/flash_sale_info',array('id'=>$vo['id'])); ?>" class="btn-bluejeans"><i class="icon-edit"></i><p>编辑</p></a>
                                </span><?php endif; ?>
                                <span>
                                    <a data-url="<?php echo U('Promotion/flash_sale_del'); ?>" data-id="<?php echo $vo['id']; ?>" onclick="delfunc(this)" class="btn-grapefruit">
