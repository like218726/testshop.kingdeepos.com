<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:45:"./application/admin/view/goods/brandList.html";i:1587634374;s:79:"/home/wwwroot/testshop.kingdeepos.com/application/admin/view/public/layout.html";i:1587634374;}*/ ?>
<!doctype html>
<html>
<head>
        ...
        <!--<input type="checkbox" name="status" value="1" style="vertical-align: middle;" />      -->
          <div class="sDiv2">
              <select name="status"  class="select">
                  <option value="" <?php if(\think\Request::instance()->param('status') === ''): ?>selected<?php endif; ?>>全部</option>
                  <option value="0" <?php if(\think\Request::instance()->param('status') === 0): ?>selected<?php endif; ?>>正常</option>
                  <option value="1" <?php if(\think\Request::instance()->param('status') == 1): ?>selected<?php endif; ?>>审核中</option>
                  <option value="2" <?php if(\think\Request::instance()->param('status') == 2): ?>selected<?php endif; ?>>审核失败</option>
              </select>
          </div>
            <div class="sDiv2">
