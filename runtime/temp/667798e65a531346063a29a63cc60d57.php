            ...
            <div class="ncsc-form-default">
                <form id="handleposition" method="post" onsubmit="return false;">
                    ...
                    <dl>
                        ...
                        <dd>
                            <a href="javascript:void(0);" onclick="selectGoods(this)" class="ncbtn ncbtn-aqua" data-prom_id="<?php echo $info['prom_id']; ?>" data-prom_type="<?php echo $info['prom_type']; ?>">选择商品</a>
                    ...
                    <div class="bbb">
                        ...
                        <table class="ncsc-default-table">
                            ...
                            <!--商品名-->
                            <tbody><label>选择的商品：</label><input type="text" id="goods_name" name="goods_name"   readonly="readonly" value="<?php echo $info['goods_name']; ?>" class="input-txt" autocomplete="off"></tbody>
                            <!--下面表格-->
                            <tbody id="selected_group_goods2">
                            <?php if(is_array($info['groupBuyGoodsItem']) || $info['groupBuyGoodsItem'] instanceof \think\Collection || $info['groupBuyGoodsItem'] instanceof \think\Paginator): $item_key = 0; $__LIST__ = $info['groupBuyGoodsItem'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$goods_item): $mod = ($item_key % 2 );++$item_key;?>
                                ...
                                <input name="team_goods_item[<?php echo $item_key-1; ?>][goods_price]" value="<?php echo $goods_item['goods_price']; ?>" type="hidden"/>
                                <tr class="bd-line">
                                    <td> <?php echo $goods_item['spec_goods_price']['key_name']; ?> </td>
                                    <td>
                                        <?php if($goods_item['item_id'] == 0): ?>
                                            <?php echo $info['goods']['store_count']; else: ?>
                                            <?php echo $goods_item['spec_goods_price']['store_count']; endif; ?>
                                    </td>
                                    <td>
                                        <?php if($goods_item['item_id'] == 0): ?>
                                            <?php echo $info['goods']['shop_price']; else: ?>
                                            <?php echo $goods_item['spec_goods_price']['price']; endif; ?>
                                    </td>
                                    <td><input name="team_goods_item[<?php echo $item_key-1; ?>][price]" class="price_make" value="<?php echo $goods_item['price']; ?>" type="text" style="width: 40%"/></td>
                                    <td><input name="team_goods_item[<?php echo $item_key-1; ?>][goods_num]" class="price_make" value="<?php echo $goods_item['goods_num']; ?>" type="text" style="width: 40%"/></td>
                                    <td><input name="team_goods_item[<?php echo $item_key-1; ?>][virtual_num]" class="price_make" value="<?php echo $goods_item['virtual_num']; ?>" type="text" style="width: 40%"/></td>
