    ...
    <dl>
      ...
      <dd>
        ...
        <p class="hint">选择是否使用店铺装修模板；<br/>
          ...
          如选择“否”根据 <a href="<?php echo U('seller/Store/store_theme'); ?>">“店铺主题”</a> 所选中的系统预设值风格进行显示。</p>
      </dd>
    </dl>
