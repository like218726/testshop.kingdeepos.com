   ...
   <div id="sidebar" class="sidebar">
	...
	<div id="layoutRight" class="ncsc-layout-right">
		...
		<div class="main-content" id="mainContent">
			<div class="tabmenu">
				<ul class="tab pngFix">
					<li class="active"><a href="<?php echo U('Freight/index'); ?>">快递公司列表</a></li>
				</ul>
			</div>
						...
						<div class="ncsc-account-container">
							...
							<ul class="ncsc-account-container-list">
								<?php if(is_array($shipping_list) || $shipping_list instanceof \think\Collection || $shipping_list instanceof \think\Paginator): $i = 0; $__LIST__ = $shipping_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$shipping): $mod = ($i % 2 );++$i;?>
									<li>
										<input type="checkbox" class="checkbox" name="shipping_id[]" value="<?php echo $shipping['shipping_id']; ?>" <?php if(in_array(($shipping['shipping_id']), is_array($store_shipping_ids)?$store_shipping_ids:explode(',',$store_shipping_ids))): ?>checked<?php endif; ?>/>
										<label><?php echo $shipping['shipping_name']; ?></label>
									</li>
								<?php endforeach; endif; else: echo "" ;endif; ?>
							</ul>
						</div>
