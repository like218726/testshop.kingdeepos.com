<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:41:"./application/admin/view/admin\login.html";i:1588218704;}*/ ?>
<!doctype html>
...
<link href="/public/static/css/login_admin.css" rel="stylesheet" type="text/css" />
...
<body>
            ...
            <div class="login-form" style="position: relative">
                <div class="formContent">
                    ...
                    <div class="formInfo">
                        ...
                        <div style="margin-bottom: 20px;" class="formText">
						...
						<div style="margin-bottom: 0;" class="formText submitDiv">
    ...
    <div id="bannerBox">
        <ul id="slideBanner" class="slideBanner">
            <li><img src="/public/static/images/admin_01.jpg"></li>
            <li><img src="/public/static/images/admin_02.jpg"></li> 
            <li><img src="/public/static/images/admin_03.jpg"></li>
                <li><img src="/public/static/images/admin_04.jpg"></li>
        </ul>
    </div>
