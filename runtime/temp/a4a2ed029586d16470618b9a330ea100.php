<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:51:"./application/admin/view/system/navigationList.html";i:1587634374;s:79:"/home/wwwroot/testshop.kingdeepos.com/application/admin/view/public/layout.html";i:1587634374;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    ...
    <div id="explanation" class="explanation" style="color: rgb(44, 188, 163); background-color: rgb(237, 251, 248); width: 99%; height: 100%;">
        ...
        <ul>
            ...
            <li>顶部导航控制前台顶部导航条菜单，底部导航控制前台底部文章</li>
                        ...
                        <tr>
                            ...
                            <td align="center" class="">
                                <div style="text-align: center; width: 80px;">
                                    <?php if($vo['position'] == 1): ?>前台-顶部
                                        <?php elseif($vo['position'] == 2): ?>前台-底部
                                        <?php else: ?>商家-底部
                                    <?php endif; ?>
                                </div>
                            </td>
