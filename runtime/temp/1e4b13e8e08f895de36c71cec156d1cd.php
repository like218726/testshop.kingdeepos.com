	...
	<div id="layoutRight" class="ncsc-layout-right">
		...
		<div class="main-content" id="mainContent">
			<div class="tabmenu">
				...
				<a href="<?php echo U('Promotion/group_buy',['prom_type'=>2]); ?>" class="ncbtn ncbtn-mint" title="新增团购"><i class="icon-plus-sign"></i>新增团购</a>
			...
			<form action="" id="search-form2" method="post" >
				<table class="search-form">
					...
					<tr>
						<td>&nbsp;</td>
						<td class="w160"><input type="text" class="text w150" name="key_word" value="<?php echo $key_word; ?>" placeholder="搜索词" /></td>
				...
				<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $k=>$vo): ?>
					<tr class="bd-line">
						...
						<td class="nscs-table-handle">
							<span><a target="_blank" href="<?php echo U('Home/Goods/goodsInfo',['id'=>$vo[goods_id],'item_id'=>$vo['group_buy_goods_item'][0]['item_id']]); ?>" class="btn-bluejeans"><i class="icon-search"></i><p>查看</p></a></span>
