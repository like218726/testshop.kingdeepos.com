            ...
            <table class="search-form">
                <form method="get" action="<?php echo U('Finance/order_statis'); ?>" id="search-form2" onsubmit="check_form();">
                    <tr>
                        ...
                        <td class="w100">
                            <input type="text" style="width: 90px;" class="text w90" id="end_time" name="end_time" value="<?php echo $end_time; ?>" placeholder="记录截止时间"/>
                        </td>
                ...
                <table class="ncsc-default-table">
                    ...
                    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                        <tr class="bd-line">
                            ...
                            <td><?php echo $v['supplier_shipping_totals']; ?></td>
                            <td><?php echo $v['result_totals']; ?></td>
                            <td><?php echo date("Y-m-d H:i",$v['create_date']); ?></td>
                            <td><a href="<?php echo U('Finance/order_list',array('id'=>$v['id'])); ?>">查看订单</a></td>
                        </tr>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                    </tbody>
                    <tfoot>
            ...
            <table class="ncsc-default-table">
                ...
                <tr>
                    ...
                    <th class="w80">运费</th>
                        ...
                        <?php if($store['is_supplier'] == 1): ?><th class="w120">供应商运费</th><?php endif; ?>
                ...
                <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                    <tr class="bd-line">
                        ...
                        <td><?php echo $v['shipping_totals']; ?></td>
                            <td><?php echo $v['get_shipping_totals']; ?></td>
                            <?php if($store['is_supplier'] == 1): ?><td><?php echo $v['supplier_shipping_totals']; ?></td><?php endif; ?>
