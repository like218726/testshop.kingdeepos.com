							...
							<?php if(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty())): ?>
								...
								<?php else: if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$group): $mod = ($i % 2 );++$i;?>
									<li>
										<div class="s_xsall">
											<div class="xs_img">
												<a target="_blank" href="<?php echo U('Home/Goods/goodsInfo',array('id'=>$group[goods_id],'item_id'=>$group['groupBuyGoodsItem'][0][item_id])); ?>">
													<img class="lazy-list" data-original="<?php echo goods_thum_images($group['goods_id'],262,262,$group['item_id']); ?>"/>
												</a>
											</div>
											...
											<div class="price-tag">
												...
												<span class="pre-per"><em><?php echo $group['groupBuyGoodsItem'][0][virtual_num] + $group['groupBuyGoodsItem'][0][order_num]; ?></em>人已参加</span>

												<div class="gb_nastr p">
													<div class="squetrian">
														<div class="arrow-right">
															<em><?php echo $group['groupBuyGoodsItem'][0][rebate]; ?></em>&nbsp;<span>折</span>
														</div>
													</div>
													<div class="old-new-prices">
														<p class="old"><span>￥</span><span><?php echo $group['groupBuyGoodsItem'][0]['goods_price']; ?></span></p>

														<p class="new"><span>￥</span><span><?php echo $group['groupBuyGoodsItem'][0]['price']; ?></span></p>
													</div>
												</div>
											</div>
										</div>
										<div class="attendgorb-ocl">
											<a target="_blank" href="<?php echo U('Home/Goods/goodsInfo',array('id'=>$group[goods_id],'item_id'=>$group['groupBuyGoodsItem'][0][item_id])); ?>" style="color: white">
												<span>立即团购<i>></i></span>
											</a>
										</div>
									</li>
