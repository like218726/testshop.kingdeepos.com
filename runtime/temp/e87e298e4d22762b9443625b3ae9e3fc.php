 ...
 <div id="layoutLeft" class="ncsc-layout-left">
  ...
  <div id="layoutRight" class="ncsc-layout-right">
    ...
    <div class="main-content" id="mainContent">
      <div class="tabmenu">
	  <ul class="tab pngFix">
	  <li class="normal"><a  href="<?php echo U('Order/virtual_list'); ?>">所有订单</a></li>
	  <li class="normal"><a  href="<?php echo U('Order/virtual_list',array('pay_status'=>0)); ?>">待付款</a></li>
	  <li class="normal"><a  href="<?php echo U('Order/virtual_list',array('pay_status'=>1)); ?>">已付款</a></li>
	  <li class="normal"><a  href="<?php echo U('Order/virtual_list',array('order_status'=>4)); ?>">已完成</a></li>
	  <li class="normal"><a  href="<?php echo U('Order/virtual_list',array('order_status'=>3)); ?>">已取消</a></li>
	  <li class="active"><a  href="<?php echo U('Order/verify_code'); ?>">兑换码兑换</a></li>
	  </ul>
	</div>
...
<script>
    ...
    $(document).ready(function(){
        function exPost() {
    		...
    		$.ajax({
    			type:'post',
    			url:"<?php echo U('Order/verify_code'); ?>",
