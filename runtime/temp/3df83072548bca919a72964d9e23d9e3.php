...
<div class="tabmenu">
  ...
  <a href="javascript:void(0)" class="ncbtn ncbtn-mint" onclick="go_class_info(this)" data-url="<?php echo U('Store/goods_class_info'); ?>">新增分类</a></div>
	<table class="ncsc-default-table" id="my_category">
	  ...
	  <?php if(empty($cat_list) || (($cat_list instanceof \think\Collection || $cat_list instanceof \think\Paginator ) && $cat_list->isEmpty())): ?>
	  <tfoot>
	    <tr>
	  ...
	  <tbody id="treet1">
	   <?php if(is_array($cat_list) || $cat_list instanceof \think\Collection || $cat_list instanceof \think\Paginator): if( count($cat_list)==0 ) : echo "" ;else: foreach($cat_list as $k=>$vo): ?>
	    <tr class="bd-line" nc_type="table_item" idvalue="1">
	      <!--<td class="tc"><input type="checkbox" class="checkitem" name="category[]" value="<?php echo $vo['cat_id']; ?>"></td>-->
	      <td class="tl">
	      <?php if($vo[deep] == 1): ?>
	      	<img src="/public/static/images/tv-collapsable.gif" class="parimg" data-id="<?php echo $vo['cat_id']; ?>">
	      	<span class="ml5" nc_type="editobj"><?php echo $vo['cat_name']; ?></span>
	      	<span class="add_ico_a"> <a class="ncbtn" data-url="<?php echo U('Store/goods_class_info',array('parent_id'=>$vo['cat_id'])); ?>" href="javascript:;" onclick="go_class_info(this)">新增下级</a></span>
	      <?php else: ?>
	      	<img src="/public/static/images/seller/blank.gif" class="preimg">
	      	<img src="/public/static/images/seller/tv-item-last.gif" class="ttimage son_cat_<?php echo $vo['parent_id']; ?>">
	      	<span class="ml5" nc_type="editobj"><?php echo $vo['cat_name']; ?></span>
	      <?php endif; ?> 	
	      </td>
	      <td><span nc_type="editobj"><?php echo $vo['cat_sort']; ?></span></td>
	      <td> <?php if($vo[is_show] == 1): ?>是<?php else: ?>否<?php endif; ?>  </td>
	      <td class="nscs-table-handle">
	        <span><a href="javascript:void(0)" data-url="<?php echo U('Store/goods_class_info',array('cat_id'=>$vo['cat_id'])); ?>" href="javascript:;" onclick="go_class_info(this)"  class="btn-bluejeans"><i class="icon-edit"></i>
	        <p>编辑</p></a></span> 
	        <span><a href="javascript:void(0)" href="javascript:void(0)" data-url="<?php echo U('Store/goods_class_save'); ?>" data-id="<?php echo $vo['cat_id']; ?>" onclick="delfun(this)" class="btn-grapefruit"><i class="icon-trash"></i>
	        <p>删除</p></a></span>
	      </td>
	    </tr>
	    <?php endforeach; endif; else: echo "" ;endif; ?>
...
$(function(){
	$(document).on("click", '.parimg', function (e) {
		var src = $(this).attr('src');
		var cat_id= $(this).attr('data-id');
		if (src == '/public/static/images/tv-expandable.gif') {
			$(".son_cat_" + cat_id).parents('tr').show();
			$(this).attr('src', '/public/static/images/tv-collapsable-last.gif');
		} else {
			$(".son_cat_" + cat_id).parents('tr').hide();
			$(this).attr('src', '/public/static/images/tv-expandable.gif');
		}
	})
})
</script>
