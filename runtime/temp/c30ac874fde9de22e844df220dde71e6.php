<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:49:"./application/admin/view/goods/goodsTypeList.html";i:1587634374;s:79:"/home/wwwroot/testshop.kingdeepos.com/application/admin/view/public/layout.html";i:1587634374;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
  ...
  <div id="explanation" class="explanation" style="color: rgb(44, 188, 163); background-color: rgb(237, 251, 248); width: 99%; height: 100%;">
    ...
    <ul>
      ...
      <li style="color:red"><strong>如果要删除某个商品模型, 请先手动解除关联的'品牌'、'规格'、'属性'后再删除</strong></li>
    </ul>
  </div>
  <div class="flexigrid">
    <div class="mDiv">
      ...
      <div class="tDiv">
      <div class="tDiv2">
        <div class="fbutton"> <a href="<?php echo U('Admin/GoodsType/index'); ?>">
        ...
        <div class="sDiv2" style="float:right;" >
          <form action="/index.php/admin/Goods/goodsTypeList" method='get' >
          	<input size="30" name="search" class="qsbox" placeholder="模型名称" type="text" value="<?php echo $search; ?>">
              ...
              <tr>
                ...
                <td align="center" class="handle">
                  <div style="text-align: center; width: 170px; max-width:170px;">
                    <a href="<?php echo U('Admin/GoodsType/index',array('id'=>$list['id'])); ?>" class="btn blue"><i class="fa fa-pencil-square-o"></i>编辑</a>
