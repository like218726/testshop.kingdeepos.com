...
<form method="get" action="<?php echo U('order/export_order'); ?>" id="search-form2">
	<input type="hidden" name="seller_order_type" value="<?php echo (isset($seller_order_type) && ($seller_order_type !== '')?$seller_order_type:0); ?>">
  ...
  <table class="search-form">
    <tr>
      ...
      <th>下单时间</th>
      <td class="w378">
	      <input type="text" class="text w150" name="start_time" id="start_time" placeholder="开始时间" value="<?php echo $start_time; ?>"/>
	      <input type="text" class="text w150" name="end_time" id="end_time" placeholder="结束时间" value="<?php echo $end_time; ?>"/>
	   </td>
     </tr>
     <tr> 
      <th>支付状态</th>
