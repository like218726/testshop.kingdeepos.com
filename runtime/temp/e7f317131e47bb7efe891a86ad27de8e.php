<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:41:"./template/pc/rainbow/user/pop_login.html";i:1587634424;}*/ ?>
<!DOCTYPE HTML>
<html lang="en">
<head>
  <meta charset="UTF-8">
  ...
  <link rel="stylesheet" href="/template/pc/rainbow/static/css/fn_login.css">
...
<div class="u-qq">
    ...
    <?php
        ...
        <?php endif; if($v['code'] == 'alipaynew'): ?>
            <a href="<?php echo U('LoginApi/login',array('oauth'=>'alipaynew')); ?>" class="pay" title="支付宝"></a>
