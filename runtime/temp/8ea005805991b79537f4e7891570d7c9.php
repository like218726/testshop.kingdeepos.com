<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:41:"./application/seller/new/admin/login.html";i:1587634376;}*/ ?>
...
.ecsc-login-container .login-right .login-logo img{
    width: 159px;
    height: 58px;
}
.login-right .items {margin-top: 5px;}
