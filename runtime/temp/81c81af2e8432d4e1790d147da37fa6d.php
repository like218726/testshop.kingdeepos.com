<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:50:"./application/admin/view/public/dispatch_jump.html";i:1587634374;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
...
.recigle .copyright{color: #3c8dbc;}
	...
	<body class="tranjump">
		<div class="rectangle_box">
			...
			<div class="recigle">
				<p>Copyright©2014-2017<em class="copyright"><a class="copyright" href="http://www.tpshop.cn/"><?php echo (isset($tpshop_config['shop_info_store_name']) && ($tpshop_config['shop_info_store_name'] !== '')?$tpshop_config['shop_info_store_name']:'TPshop商城'); ?> v3.0.0</a></em></p>
				<p><em class="copyright"><a class="copyright" href="http://www.tpshop.cn/"><?php echo (isset($tpshop_config['shop_info_store_title']) && ($tpshop_config['shop_info_store_title'] !== '')?$tpshop_config['shop_info_store_title']:'深圳搜豹网络有限公司'); ?></a></em>出品</p>
			</div>
		</div>
